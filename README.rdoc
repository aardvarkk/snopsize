...
The devise views are located under app/views/devise and can be skinned for custom UI.
...
==== Domain Page
The domain page (app/views/domains/show.html.erb) shows a table of resources for that domain. This allows the user to view all articles that have been snopped about for a particular domain (ex. www.theconomist.com/)
